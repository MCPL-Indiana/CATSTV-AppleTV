//
//  CityMeetingsService.swift
//  CatsTV
//
//  Fetches and decodes the City Meetings JSON feed from MCPL.
//

import Foundation

actor CityMeetingsService {
    static let shared = CityMeetingsService()
    private init() {}

    private let feedURL = URL(string: "https://3w.mcpl.info/catsjson/city.json")!
