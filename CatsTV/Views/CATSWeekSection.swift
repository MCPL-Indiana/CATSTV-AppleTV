//
//  CATSWeekSection.swift
//  CatsTV
//
//  Horizontal scrolling section that loads CATSWeek videos from the CATS
//  JSON feed and lets users browse and play them.
//

import SwiftUI

struct CATSWeekSection: View {
    ...
    private func load() async {
        ...
        errorMessage = nil
        do {
            videos = try await CATSWeekService.shared.fetchVideos()
        } catch {
